...
class SystemSectionNavigationRegistry
{
    public static function items(): array
    {
        return [
            ...
            [
                'key' => 'reviewer.contract-signatures',
                'label' => 'Tanda Tangan',
                'icon' => 'ScrollText',
                'surface' => 'reviewer',
                'routeName' => 'reviewer.contract-signatures.index',
                'activePatterns' => ['reviewer.contract-signatures.*'],
                'pathPrefixes' => ['/reviewer/contract-signatures'],
                'requiredPermission' => SystemNavigation::MANAGE_REVIEWER_REVIEWS,
            ],
            [
            ...
            [
                ...
                'subItems' => [
                    ...
                    [
                        'key' => 'admin.requests.contract-signatures',
                        'label' => 'Tanda Tangan Kontrak',
                        'icon' => 'ScrollText',
                        'routeName' => 'admin.signatures.contracts.index',
                        'activePatterns' => ['admin.signatures.*'],
                        'pathPrefixes' => ['/admin/signatures'],
                    ],
                    [
            ...
            [
                ...
                'icon' => 'CreditCard',
                'surface' => 'admin',
                'routeName' => 'admin.finance.billings.index',
                'activePatterns' => ['admin.finance.*'],
                'pathPrefixes' => ['/admin/keuangan'],
                'requiredPermission' => SystemNavigation::MANAGE_ADMIN_FINANCE,
                'subItems' => [
                    [
                        'key' => 'admin.finance.billings',
                        'label' => 'Tagihan',
                        'icon' => 'ReceiptText',
                        'routeName' => 'admin.finance.billings.index',
                        'activePatterns' => ['admin.finance.billings.*'],
                        'pathPrefixes' => ['/admin/keuangan/tagihan'],
                    ],
                    [
                        ...
                        'activePatterns' => ['admin.finance.payments.*'],
                        'pathPrefixes' => ['/admin/keuangan/pembayaran'],
                    ],
                    [
                        'key' => 'admin.finance.tax-invoices',
                        'label' => 'Faktur Pajak',
                        'icon' => 'FileText',
                        'routeName' => 'admin.finance.tax-invoices.index',
                        'activePatterns' => ['admin.finance.tax-invoices.*'],
                        'pathPrefixes' => ['/admin/keuangan/faktur-pajak'],
                    ],
                    [
                        'key' => 'admin.finance.withholding-receipts',
                        'label' => 'Bukti Potong',
                        'icon' => 'Files',
                        'routeName' => 'admin.finance.withholding-receipts.index',
                        'activePatterns' => ['admin.finance.withholding-receipts.*'],
                        'pathPrefixes' => ['/admin/keuangan/bukti-potong'],
                    ],
                ],
            ],
            [
