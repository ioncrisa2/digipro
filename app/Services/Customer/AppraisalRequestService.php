...
class AppraisalRequestService
{
    public function createFromRequest(Request $request): AppraisalRequest
    {
        ...
        $appraisalRequest = DB::transaction(function () use ($request, $validated, $format, $copies, $reportType, $purpose, $clientName, $submitter, $guardName, $guidelineSetId, $consentSnapshot) {
