...
Route::middleware(['auth', 'verified', 'customer.role'])
    ->group(function (): void {
        ...
        Route::post('/permohonan-penilaian/{id}/kontrak/onboarding/identity-and-register', [AppraisalController::class, 'completeContractOnboardingIdentity'])->name('appraisal.contract.onboarding.identity-and-register');
        ...
        Route::post('/permohonan-penilaian/{id}/kontrak/onboarding/refresh-silent', [AppraisalController::class, 'refreshContractOnboardingSilently'])->name('appraisal.contract.onboarding.refresh-silent');
